...
Este programa calcula la fuerza magn彋ica que act�a sobre un conductor rectil璯eo, la intensidad de la corriente, la longitud del conductor, el campo magn彋ico 
o el 嫕gulo que forman el conductor y el campo magn彋ico (a elecci鏮 del usuario), introduciendo por teclado el resto de variables*/
#include <stdio.h>
#include <math.h>
